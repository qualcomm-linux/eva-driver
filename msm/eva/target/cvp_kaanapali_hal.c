...
static void __enter_cpu_noc_lpi_kaanapali(struct iris_hfi_device *device,
...
static void __enter_core_noc_lpi_kaanapali(struct iris_hfi_device *device,
				enum enter_noc_lpi_caller caller)
{
...
static void __enter_video_ctl_noc_lpi_kaanapali(struct iris_hfi_device *device,
					enum enter_noc_lpi_caller caller)
{
	u32 lpi_status, count = 0, max_count = 2000;
...
static void __stop_transactions_interrupt_kaanapali(struct iris_hfi_device *device)
{
...
advance:
	/* New addition to put CORE NOC to low power Section 6.14 (Steps 4-6)*/
	__enter_core_noc_lpi_kaanapali(device, POWER_OFF_CORE);
...
int __power_off_controller_kaanapali(struct iris_hfi_device *device)
{
	 ...
	 * (Steps 15-17)
	 */
	__enter_cpu_noc_lpi_kaanapali(device, POWER_OFF_CNTRL);

	/* New addition to put CVP_VIDEO_CTL NOC to low power Section 6.14
	 * (Steps 19-21)
	 */
	__enter_video_ctl_noc_lpi_kaanapali(device, POWER_OFF_CNTRL);
...
int set_kaanapali_hal_functions(void)
{
	...
	hal_ops.enter_cpu_noc_lpi = __enter_cpu_noc_lpi_kaanapali;
	hal_ops.enter_video_ctl_noc_lpi = __enter_video_ctl_noc_lpi_kaanapali;
	hal_ops.enter_core_noc_lpi = __enter_core_noc_lpi_kaanapali;
	hal_ops.stop_transactions_interrupt = __stop_transactions_interrupt_kaanapali;
