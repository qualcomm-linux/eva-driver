...
#ifndef __CVP_HAWI_IO_H__
#define __CVP_HAWI_IO_H__
...
/*TCSR_SOC_HW_VERSION */
#define CVP_CPU_CS_SCIBCMDARG3		(CVP_CPU_BASE_OFFS + 0x6C)
...
#define CVP_WRAPPER_GPIO_IN (CVP_WRAPPER_BASE_OFFS + 0x28)
#define CVP_WRAPPER_GPIO_OUT (CVP_WRAPPER_BASE_OFFS + 0x2C)
...
#define HFI_DSP_UC_REGION_SIZE	CVP_CPU_CS_VMIMSGAG1
 /*
  * --------------------------------------------------------------------------
  * MODULE: cvp_wrapper_xtss
  * --------------------------------------------------------------------------
  */
#define CVP_WRAPPER_XTS_OFFS		0x000C0000
#define CVP_WRAPPER_XTSS_SW_RESET_RO	(CVP_WRAPPER_XTS_OFFS + 0x20)
...
#define CVP_NOC_A_NIU_DECCTL_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3108)
#define CVP_NOC_A_NIU_ENCCTL_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3188)
#define CVP_NOC_B_NIU_DECCTL_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3508)
#define CVP_NOC_B_NIU_ENCCTL_LOW \
...
#define CVP_NOC_A_PRIORITYLUT_HIGH \
		(CVP_NOC_CORE_BASE_OFFS + 0x3034)
#define CVP_NOC_A_URGENCY_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3038)
#define CVP_NOC_A_DANGERLUT_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3040)
#define CVP_NOC_A_SAFELUT_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3048)
#define CVP_NOC_B_PRIORITYLUT_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3430)
#define CVP_NOC_B_PRIORITYLUT_HIGH \
		(CVP_NOC_CORE_BASE_OFFS + 0x3434)
#define CVP_NOC_B_URGENCY_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3438)
#define CVP_NOC_B_DANGERLUT_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3440)
#define CVP_NOC_B_SAFELUT_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3448)
#define CVP_NOC_C_PRIORITYLUT_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3830)
#define CVP_NOC_C_PRIORITYLUT_HIGH \
		(CVP_NOC_CORE_BASE_OFFS + 0x3834)
#define CVP_NOC_C_URGENCY_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3838)
#define CVP_NOC_C_DANGERLUT_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x3840)
#define CVP_NOC_C_SAFELUT_LOW \
...
#define CVP_NOC_RCGCONTROLLER_WAKEUP_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0xC018)
#define CVP_NOC_RESET_REQ \
		(CVP_NOC_CORE_BASE_OFFS + 0xf000)
#define CVP_NOC_RESET_ACK \
		(CVP_NOC_CORE_BASE_OFFS + 0xf004)
#define CVP_NOC_RESET_SYNCRST \
		(CVP_NOC_CORE_BASE_OFFS + 0xf008)

#define CVP_VIDEO_B_NOC_A_QOSGEN_MAINCTL_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x0008)
#define CVP_VIDEO_B_NOC_B_QOSGEN_MAINCTL_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x0088)
#define CVP_VIDEO_B_NOC_C_QOSGEN_MAINCTL_LOW \
		(CVP_NOC_CORE_BASE_OFFS + 0x0108)
...
#define CVP_AON_WRAPPER_CVP_VIDEO_CTL_NOC_LPI_CONTROL	(CVP_AON_BASE_OFFS + 0x2C)
#define CVP_AON_WRAPPER_CVP_VIDEO_CTL_NOC_LPI_STATUS	(CVP_AON_BASE_OFFS + 0x30)

#define CVP_CC_BASE_OFFS			0xF8000
#define CVP_CC_MVS0C_GDSCR			(CVP_CC_BASE_OFFS + 0x34)
#define CVP_CC_MVS0C_DEBUG_CBCR			(CVP_CC_BASE_OFFS + 0x4C)
#define CVP_CC_MVS0C_CBCR			(CVP_CC_BASE_OFFS + 0x50)
#define CVP_CC_MVS0_GDSCR			(CVP_CC_BASE_OFFS + 0x70)
#define CVP_EVA_CC_MVS0_CFG_GDSCR		(CVP_CC_BASE_OFFS + 0x74)
#define CVP_CC_MVS0_CBCR			(CVP_CC_BASE_OFFS + 0x84)
#define CVP_CC_AHB_CBCR				(CVP_CC_BASE_OFFS + 0xA4)
#define CVP_CC_SLEEP_CBCR			(CVP_CC_BASE_OFFS + 0xE4)
#define CVP_CC_MM_INT_GDSCR			(CVP_CC_BASE_OFFS + 0xE8)
#define CVP_CC_AXI0_CX_INT_GDSCR		(CVP_CC_BASE_OFFS + 0x100)
...
#define TCSR_REG_BASE					0x03A20000
#define TCSR_REG_SIZE					0x1E0000

#define TCSR_SOW_HW_VERSION				0xB1000
