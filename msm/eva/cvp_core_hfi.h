...
#define CVP_IFACEQ_MAX_CMD_BUF_COUNT		50
...
#define CVP_IFACEQ_CMD_QUEUE_SIZE	(CVP_IFACEQ_MAX_PKT_SIZE *  \
	CVP_IFACEQ_MAX_CMD_BUF_COUNT * CVP_IFACE_MAX_PARALLEL_CLNTS)
#define CVP_IFACEQ_MSG_QUEUE_SIZE	(CVP_IFACEQ_MAX_PKT_SIZE *  \
	CVP_IFACEQ_MAX_MSG_BUF_COUNT * CVP_IFACE_MAX_PARALLEL_CLNTS)
...
#define ALIGNED_SW_DBG_BUF_SIZE ALIGN(SW_DBG_BUF_SIZE, PAGE_SIZE)
#define ALIGNED_QUEUE_SIZE ALIGN(QUEUE_SIZE, PAGE_SIZE)
