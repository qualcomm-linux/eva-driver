...
#define CVP_AON_WRAPPER_CVP_VIDEO_CTL_NOC_LPI_CONTROL	(CVP_WRAPPER_BASE_OFFS + 0x78)
#define CVP_AON_WRAPPER_CVP_VIDEO_CTL_NOC_LPI_STATUS	(CVP_WRAPPER_BASE_OFFS + 0x78)
#endif
