...
#define  HFI_PROPERTY_SYS_EVA_FW_VERSION HFI_PROPERTY_SYS_IMAGE_VERSION
...
#define HFI_DEBUG_CFG_BUF_CRC_EN			HFI_DEBUG_MSG_CRC_EN
...
#define HFI_MSG_SESSION_EVA_START_DONE	HFI_MSG_SESSION_EVA_START
#define HFI_MSG_SESSION_EVA_STOP_DONE	HFI_MSG_SESSION_EVA_STOP
